...
--
-- Host: localhost    Database: mini_wallet_db
-- ------------------------------------------------------
...
CREATE TABLE `wallets` (
  ...
  CONSTRAINT `wallets_ibfk_1` FOREIGN KEY (`owned_by`) REFERENCES `customers` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-02-28  0:43:19
